...
[![Install module `main:endoflife`](https://img.shields.io/badge/Install_module-main:endoflife-blue)](https://gterminal.js.org/?cmd=modules+install+main:endoflife)
[![Remove module `main:endoflife`](https://img.shields.io/badge/Remove_module-main:endoflife-blue)](https://gterminal.js.org/?cmd=modules+remove+main:endoflife)
...
[![Install module `main:github`](https://img.shields.io/badge/Install_module-main:github-blue)](https://gterminal.js.org/?cmd=modules+install+main:github)
[![Remove module `main:github`](https://img.shields.io/badge/Remove_module-main:github-blue)](https://gterminal.js.org/?cmd=modules+remove+main:github)
...
[![Install module `main:google`](https://img.shields.io/badge/Install_module-main:google-blue)](https://gterminal.js.org/?cmd=modules+install+main:google)
[![Remove module `main:google`](https://img.shields.io/badge/Remove_module-main:google-blue)](https://gterminal.js.org/?cmd=modules+remove+main:google)
...
[![Install module `main:openai`](https://img.shields.io/badge/Install_module-main:openai-blue)](https://gterminal.js.org/?cmd=modules+install+main:openai)
[![Remove module `main:openai`](https://img.shields.io/badge/Remove_module-main:openai-blue)](https://gterminal.js.org/?cmd=modules+remove+main:openai)
...
[![Install module `main:shortlinks`](https://img.shields.io/badge/Install_module-main:shortlinks-blue)](https://gterminal.js.org/?cmd=modules+install+main:shortlinks)
[![Remove module `main:shortlinks`](https://img.shields.io/badge/Remove_module-main:shortlinks-blue)](https://gterminal.js.org/?cmd=modules+remove+main:shortlinks)
...
[![Install module `main:twitch`](https://img.shields.io/badge/Install_module-main:twitch-blue)](https://gterminal.js.org/?cmd=modules+install+main:twitch)
[![Remove module `main:twitch`](https://img.shields.io/badge/Remove_module-main:twitch-blue)](https://gterminal.js.org/?cmd=modules+remove+main:twitch)
...
[![Install module `main:webdev`](https://img.shields.io/badge/Install_module-main:webdev-blue)](https://gterminal.js.org/?cmd=modules+install+main:webdev)
[![Remove module `main:webdev`](https://img.shields.io/badge/Remove_module-main:webdev-blue)](https://gterminal.js.org/?cmd=modules+remove+main:webdev)
...
[![Install module `main:whatsapp`](https://img.shields.io/badge/Install_module-main:whatsapp-blue)](https://gterminal.js.org/?cmd=modules+install+main:whatsapp)
[![Remove module `main:whatsapp`](https://img.shields.io/badge/Remove_module-main:whatsapp-blue)](https://gterminal.js.org/?cmd=modules+remove+main:whatsapp)
...
[![Install module `main:you`](https://img.shields.io/badge/Install_module-main:you-blue)](https://gterminal.js.org/?cmd=modules+install+main:you)
[![Remove module `main:you`](https://img.shields.io/badge/Remove_module-main:you-blue)](https://gterminal.js.org/?cmd=modules+remove+main:you)
...
[![Install module `main:youtube`](https://img.shields.io/badge/Install_module-main:youtube-blue)](https://gterminal.js.org/?cmd=modules+install+main:youtube)
[![Remove module `main:youtube`](https://img.shields.io/badge/Remove_module-main:youtube-blue)](https://gterminal.js.org/?cmd=modules+remove+main:youtube)
